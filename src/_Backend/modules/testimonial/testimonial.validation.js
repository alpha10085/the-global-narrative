...
const testimonialValidationCreate = Joi.object({
  content: joiText({ min: 2, max: 1000, required: true }),
  jobTitle: joiText({ min: 2, max: 1000, required: true }),
  author: joiText({ min: 2, max: 1000, required: true }),
...
const testimonialValidationUpdate = Joi.object({
  content: joiText({ min: 2, max: 1000 }),
  jobTitle: joiText({ min: 2, max: 1000 }),
  author: joiText({ min: 2, max: 1000 }),
  poster: fileVal,
  ...CommonsVal,
});
